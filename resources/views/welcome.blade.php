...
<body class="premium-bg min-h-screen relative overflow-x-hidden selection:bg-amber-100 selection:text-amber-900">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="glass-panel rounded-2xl px-6 py-3 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3 md:gap-4">
                    <div class="w-10 h-10 md:w-11 md:h-11 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 text-white">
